...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        Log.d(this.getClass().getSimpleName(), "runPendingAnimations: mPendingAdditions=" + mPendingAdditions.size() +
            " , mPendingChanges="+mPendingChanges.size() + " ,mPendingRemovals="+mPendingRemovals.size() +", mPendingRemovals" +mPendingMoves.size()
        );
        // First, remove stuff
