package com.abclauncher.powerboost.share.ShareIndicator.navigator;
...
import com.abclauncher.powerboost.share.ShareIndicator.IPagerNavigator;
import com.abclauncher.powerboost.share.ShareIndicator.NavigatorHelper;
...
public class ScaleCircleNavigator extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public int mNormalCircleColor = Color.LTGRAY;
    public int mSelectedCircleColor = Color.GRAY;
    ...
    private void init(Context context) {
        ...
        mMinRadius = resources.getDimensionPixelSize(R.dimen.indicator_min_radius);
        mMaxRadius = resources.getDimensionPixelSize(R.dimen.indicator_max_radius);
        mCircleSpacing = resources.getDimensionPixelSize(R.dimen.circle_space);
