package com.abclauncher.powerboost.locker.view;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs,
        ...
        bgPaint.setColor(getContext().getResources().getColor(R.color.charging_pb_bg_color));
    ...
    public void setCenterTextSize(int centerTextSize) {
        this.centerTextSize = LockerUtils.dip2px(context, centerTextSize);
    }
